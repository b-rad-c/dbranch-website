...
export default function About() {
    return (
        <main style={{ padding: "1rem 0" }}>
            ...
            <p>dBranch.news is a DAO-based approach to decentralizing the news media using web3 technology. The idea is to break up the news into several branches. By decoupling each branch’s financial incentives, we can minimize pernicious aspects of the legacy media’s business model.</p>
